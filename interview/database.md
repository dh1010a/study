...
<details>
  ...
  <ul>
    <li></li>
    <li>MVCC는 Multi-Version Concurrency Control의 약자로, 하나의 데이터를 여러 버전으로 관리해 락 없이 동시 접근이 가능하도록 하는 동시성 제어 기법입니다. 트랜잭션이 시작될 때 자신의 시점에 맞는 스냅샷을 읽고,
      쓰기 작업은 새로운 버전을 생성합니다. 덕분에 읽기와 쓰기가 서로 블로킹되지 않으며, PostgreSQL이나 InnoDB에서 Undo Log를 이용해 구현됩니다</li>
  </ul>
</details>
